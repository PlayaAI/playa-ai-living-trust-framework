...
Privacy, consumer-protection, employment, health, financial, biometric, children's, communications, intellectual-property, cybersecurity, and AI rules vary by jurisdiction and use case. Obtain advice from qualified counsel familiar with your organization, data flows, users, and deployment locations.

## Not a deployable representation

Do not publish a template as your privacy notice until every factual claim has been verified against deployed systems, vendors, contracts, retention processes, security controls, and user interfaces. Publishing inaccurate commitments can create legal and trust risk.
...
Deletion from active systems does not necessarily mean immediate removal from disaster-recovery backups, immutable security records, aggregates, or previously trained model parameters. Encryption and pseudonymization are not anonymity. Machine unlearning remains context-dependent and must not be promised without evidence.

## Third-party rights

This repository may discuss third-party frameworks, organizations, and terminology for research or interoperability. Their names, marks, publications, licenses, and permissions remain subject to their owners' terms. See [TRADEMARKS.md](TRADEMARKS.md).
